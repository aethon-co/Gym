...
const Attendance = () => {
  ...
  return (
    <div
      className="p-6 max-w-7xl mx-auto h-screen overflow-y-auto bg-gray-50"
    >
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
        ...
        <div className="mt-4 flex justify-between items-center text-sm text-gray-600">
          <span>
            Showing {filteredAttendance.length} of {attendanceData.length} members
          </span>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            {attendanceData.length === 0
              ? `No members checked in on ${new Date(
                  selectedDate
                ).toLocaleDateString()}`
                        ...
                        <div className="flex-shrink-0 h-10 w-10">
                          <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center">
                            <span className="text-sm font-medium text-blue-600">
                              {record.memberId?.name?.charAt(0)?.toUpperCase() ||
                                "U"}
                            </span>
                          </div>
                        </div>
